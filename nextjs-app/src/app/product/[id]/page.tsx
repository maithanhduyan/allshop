...
export default function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // In a real app, fetch product by id. For demo, use mock data
  const resolvedParams = { id: '1' } // params will be resolved by Next.js
  const item = MOCK_PRODUCTS.find((p) => p.id === resolvedParams.id) ?? MOCK_PRODUCT
