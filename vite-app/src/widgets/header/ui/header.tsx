...
import { selectCartCount } from '@/entities/cart/model/selectors'
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-2.5 md:gap-6 md:py-3">
        ...
        {/* Search — always visible, grows full width on mobile */}
        ...
        <div className="flex shrink-0 items-center gap-1 md:gap-2">
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute -right-1 -top-1 flex h-5 w-5 animate-bounce-in items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white ring-2 ring-white dark:ring-gray-950">
